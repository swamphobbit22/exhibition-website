...
const Showcase = () => {
  ...
  return (
    ...
    <div className="relative min-h-screen pt-28 flex items-center flex-col mx-20 text-[var(--text-primary)] ">
      <h2 className="font-serif text-4xl sm:text-4xl font-bold mb-4">The Daily Showcase</h2> 
      {/* <h3 className="font-serif text-xl sm:text-3xl font-bold mb-4">Discover Art and Antiquities from Across the Globe</h3> */}
      <span className="text-[var(--text-primary)] leading-6 max-w-4xl mx-auto mb-4">
      ...
      <h3 className=" text-2xl text-center font-light mb-2">
        Todays theme is... <span className="text-4xl font-semibold text-[var(--text-accent)]">{`${theme.name}`}</span>
      </h3>
